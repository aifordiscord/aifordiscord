...
|--------|-------------|------|---------|
| [🔗 aifordiscord](https://github.com/aifordiscord/aifordiscord) | Config files for my GitHub profile. | config, github-config | Ai-coded |
| [🔗 Website-portfolio](https://github.com/aifordiscord/Website-portfolio) | No description | Unknown | Ai-coded |
| [🔗 discord-bot](https://github.com/aifordiscord/discord-bot) | A discord bot templet in discord.js | bot, discord, discord-bot, discord-js, javascript, python | Ai-coded |
| [🔗 Blogging-template](https://github.com/aifordiscord/Blogging-template) | Advance blogging website template | blog, blogging, html, netfly, tailwindcss, typescript, vercel, website | Ai-coded |
| [🔗 aifordiscord-translator](https://github.com/aifordiscord/aifordiscord-translator) | A translator package for discord | Unknown | Ai-coded |
<!--PROJECTS-END-->
